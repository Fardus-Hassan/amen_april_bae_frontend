...
export default function LoginPage() {
  ...
  return (
    <div className="w-full sm:p-10 sm:shadow-[0_4px_24px_rgba(0,0,0,0.08)] sm:rounded-2xl">
      {/* Logo + DNA Time Machine - same as register */}
        ...
        <div className="flex items-center justify-between">
          <label className="flex cursor-pointer items-center gap-2 text-sm text-[#4a5568]">
            <input
              ...
              className="h-4 w-4 rounded border-gray-300 text-[#1a2b4c] focus:ring-[#1a2b4c]"
            />
            Remember Me
          </label>
          <Link
